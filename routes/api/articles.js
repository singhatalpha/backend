...
const storage = new GridFsStorage({
  url: 'mongodb://alpha:12qwaszx-V@157.245.109.205:27017/admin?authSource=admin&readPreference=primary&ssl=false&retryWrites=true&w=majority',
  file: (req, file) => {
    return new Promise((resolve, reject) => {
      crypto.randomBytes(16, (err, buf) => {
        ...
        const filename = "https://knowingisowning.com/api/load/"+token
